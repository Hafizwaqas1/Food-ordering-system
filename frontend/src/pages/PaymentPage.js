    ...
    <div className='container py-5'>
      ...
      <div className='card p-4 shadow-sm'>
          <div className='mb-3'>
            ...
            <textarea className='form-control border-primary-subtle' rows="3" required placeholder='Enter your full delivery address' value={address}
            ...
            <div className='form-check mb-3'>
                <input className='form-check-input'
                type="radio" name="paymentMode"
                value="online" required checked={paymentMode === 'online'}
